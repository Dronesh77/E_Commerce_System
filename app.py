...
# load files===========================================================================================================
trending_products = pd.read_csv("/Users/yutika/Documents/Smart_E_Commerece_Recommendation/trending_products.csv")
train_data = pd.read_csv("/Users/yutika/Documents/Smart_E_Commerece_Recommendation/clean_data.csv")
...
def recommendations():
    if request.method == 'POST':
        ...
        if content_based_rec.empty:
            ...
            return render_template('main.html', message=message,content_based_rec=None) #pd.DataFrame()
        else:
